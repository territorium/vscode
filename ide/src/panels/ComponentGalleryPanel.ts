...
export class ComponentGalleryPanel {
    ...
    if (ComponentGalleryPanel.currentPanel) {
      ...
      const panel = window.createWebviewPanel(
        ...
        // Extra panel configurations
        {
          ...
          localResourceRoots: [Uri.joinPath(extensionUri, Defaults.OUT_DIR)],
        }
      );
  ...
  private _getWebviewContent(webview: Webview, extensionUri: Uri) {
    const webviewUri = getUri(webview, extensionUri, [Defaults.OUT_DIR, "webview.js"]);
    const styleUri = getUri(webview, extensionUri, [Defaults.OUT_DIR, "style.css"]);
    const codiconUri = getUri(webview, extensionUri, [Defaults.OUT_DIR, "codicon.css"]);
